...
import { RitualFinder } from "@/features/rituals/components/ritual-finder";
    ...
    <main id="main-content">
      ...
      <section className="section ritual-paths">
        ...
        <div className="ritual-path-grid">
          <Link href="/shop?goal=Cleanse"><span>01</span><h3>Cleanse</h3><p>Reetha and Shikakai, compared with care.</p><i>Explore ↗</i></Link>
          <Link href="/shop?goal=Softness+%2B+Shine"><span>02</span><h3>Condition</h3><p>Amla and Hibiscus for softness-focused masks.</p><i>Explore ↗</i></Link>
          <Link href="/shop?goal=Scalp+Ritual"><span>03</span><h3>Ground</h3><p>Bhringraj and Amla for scalp-to-length rituals.</p><i>Explore ↗</i></Link>
          <Link href="/shop?goal=Botanical+Colour"><span>04</span><h3>Colour</h3><p>Indigo guidance with honest variables and safety.</p><i>Explore ↗</i></Link>
        </div>
      </section>
    </main>
  );
