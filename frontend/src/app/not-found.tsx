...
export default function NotFound() {
  return (
    <main id="main-content" className="flex min-h-[72vh] flex-col items-center justify-center px-[25px] py-20 text-center">
      ...
      <h1 className="my-[15px] font-serif text-[clamp(3.5rem,6vw,7rem)] font-normal leading-[0.9] tracking-[-0.06em] text-[var(--forest)]">The ritual isn’t here.</h1>
      <p className="text-[var(--muted)]">Return to the botanical cabinet and begin again.</p>
