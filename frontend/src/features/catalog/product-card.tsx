    ...
    >
      <div className="relative flex h-[clamp(330px,28vw,430px)] flex-none items-end justify-center overflow-hidden pb-[35px] [background:radial-gradient(circle_at_50%_78%,rgba(255,255,255,0.95)_0,rgba(255,255,255,0.28)_28%,transparent_55%),linear-gradient(145deg,color-mix(in_srgb,var(--product-soft)_72%,white),var(--product-soft))] before:absolute before:top-[14%] before:h-[65%] before:w-[65%] before:rounded-t-[50%] before:border before:border-[color-mix(in_srgb,var(--product-accent)_35%,transparent)] before:content-[''] max-[800px]:pb-7 max-[680px]:h-[clamp(200px,55vw,300px)] max-[680px]:pb-4 max-[520px]:h-[200px] @max-[220px]:h-[350px] @max-[220px]:pb-6 @max-[220px]:before:top-[10%] @max-[220px]:before:h-[72%] @max-[220px]:before:w-[88%]">
        ...
        <Link
          ...
          className="relative z-[2] flex min-h-[270px] min-w-[180px] items-end justify-center max-[680px]:min-h-[170px] max-[680px]:min-w-0 @max-[220px]:min-h-[270px] @max-[220px]:w-full @max-[220px]:min-w-0"
          onClick={() =>
      ...
      <div className="flex flex-1 flex-col px-[30px] pb-[30px] pt-7 max-[800px]:px-6 max-[680px]:px-4 max-[680px]:pb-4 max-[680px]:pt-4 @max-[220px]:px-3 @max-[220px]:pt-4 @max-[220px]:pb-4">
        ...
        <p className="mb-6 mt-2.5 min-h-[2.5em] text-[0.78rem] leading-[1.5] tracking-[0.04em] text-[var(--muted)] max-[680px]:mb-3 max-[680px]:line-clamp-2 max-[680px]:min-h-0 max-[680px]:text-[0.68rem] @max-[220px]:mb-4 @max-[220px]:mt-2 @max-[220px]:line-clamp-2 @max-[220px]:min-h-[2.8em] @max-[220px]:text-[0.7rem] @max-[220px]:leading-[1.4] @max-[220px]:tracking-normal">{product.subtitle}</p>
        <div className="mt-auto flex items-end justify-between gap-[15px] border-t border-[var(--line)] pt-5 max-[680px]:pt-3 max-[680px]:gap-2 @max-[220px]:gap-2 @max-[220px]:pt-3">
          <div className="grid">
            <span className="font-serif text-xl text-[var(--forest)] max-[680px]:text-base @max-[220px]:text-lg">{formatCurrency(product.pricePaise)}</span>
            <span className="text-[0.52rem] tracking-[0.11em] text-[var(--muted)] uppercase max-[680px]:hidden @max-[220px]:hidden">Preview price</span>
          </div>
          <button
            type="button"
