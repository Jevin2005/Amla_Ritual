...
export function WishlistPage() {
  ...
  return (
    <section className="mx-auto min-h-[600px] w-full max-w-[1500px] px-[clamp(25px,6vw,96px)] py-[clamp(92px,10vw,155px)] max-[680px]:px-5 max-[680px]:py-[85px]" aria-labelledby="saved-title">
      ...
      <div className="grid grid-cols-2 gap-[22px] [&>article>div:first-child]:h-[clamp(340px,32vw,460px)] max-[680px]:grid-cols-1 max-[680px]:[&>*]:w-full">
