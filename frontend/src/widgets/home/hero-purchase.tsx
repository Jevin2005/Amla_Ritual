...
export function HeroPurchase({ slug, name, pricePaise }: HeroPurchaseProps) {
  ...
  return (
    <div className="w-full max-w-[430px]">
      ...
      <a
        className="group mt-2.5 inline-flex min-h-11 items-center gap-1.5 text-[0.62rem] font-bold tracking-[0.1em] text-[var(--forest)] uppercase max-[680px]:mt-2 max-[680px]:gap-1.5 max-[680px]:text-[0.68rem]"
